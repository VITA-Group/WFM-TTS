...
class ARBaseGenerationPipeline(BaseWorldGenerationPipeline):
    ...
    def __init__(
        ...
        parallel_size: int = 1,
        test_time_scaling_mode: str = None,
    ):
        ...
        self.test_time_scaling_mode = test_time_scaling_mode
    ...
    def generate(
        ...
        output_video = out_videos_cur_batch
    ...
    def generate_partial_tokens_from_data_batch(
        ...
        for sample_num in range(batch_size):
            ...
            for video_dec, idx_tensor in zip(video_decoded, indices_tensor):
                out_videos[chunk_idx].append(video_dec.detach().clone())
                out_indices_tensors[chunk_idx].append(idx_tensor.detach().clone())
    ...
    def generate_video_from_tokens(
        ...
        generation_tokens, _ = self.model.generate(
            ...
            verbose=True,
            tts_mode=self.test_time_scaling_mode,
            latent_shape=latent_shape,
        )
